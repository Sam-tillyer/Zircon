            ...
            switch (CurrentAction)
            {
                ...
                case MirAction.Spell:
                    ...
                    switch (MagicType)
                    {
                        ...
                        case MagicType.ChainHeal:
                            foreach (Point point in MagicLocations)
                            {
                                spell = new MirEffect(870, 10, TimeSpan.FromMilliseconds(100), LibraryFile.MagicEx9, 10, 35, Globals.HolyColour)
                                {
                                    Blend = true,
                                    MapTarget = point,
                                };
                            ...
                            DXSoundManager.Play(SoundIndex.ChainHealEnd);
                            break;
...
/*case MirAction.Struck:
                ...
                case MirAction.Spell:
                    ...
                    switch (MagicType)
                    {
                        ...
                        case MagicType.ChainHeal:
                            Effects.Add(spell = new MirEffect(840, 10, TimeSpan.FromMilliseconds(100), LibraryFile.MagicEx9, 10, 35, Globals.HolyColour)
                            {
                                Blend = true,
                                Target = this
                            });
                            DXSoundManager.Play(SoundIndex.ChainHealStart);
                            break;
